<%@ Page Title="Loan Settlement / Foreclosure Report" Language="C#"
    ...
    CodeBehind="LoanClosedReport.aspx.cs"
    Inherits="TheEMIClubApplication.Reports.LoanClosedReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <div class="container-fluid px-4 py-4 loan-report">
        ...
        <div class="mb-4">
            ...
            <small class="text-muted">Show All Closed Report</small>
        </div>
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-4">
                <div class="kpi-card bg-warning text-dark">
                     <i class="bi bi-currency-rupee kpi-icon"></i>
                    <div>
                        <div class="kpi-title">Total Settle/Closure Charge</div>
                        <div class="kpi-value">
...
<div class="card shadow-lg">
    <div class="card-header gradient-dark text-white">
        <i class="bi bi-table me-2"></i> Close Loan Details
    </div>
    ...
    <ItemTemplate>
        <asp:Label ID="lblSrNo" runat="server"></asp:Label>
                ...
                <asp:BoundField HeaderText="Due EMI" DataField="DuesEMI" />
                                     ...
                                     <asp:BoundField HeaderText="Settle/Closure Charge" DataField="SettlementOrForeclosureCharg" DataFormatString="{0:N2}" />
                     <asp:BoundField HeaderText="LateFine Amount" DataField="FineAmount" DataFormatString="{0:N2}" />
